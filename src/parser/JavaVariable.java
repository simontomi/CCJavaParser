...
public class JavaVariable implements java.io.Serializable {
    ...
    public JavaFunction getParamInFunc() {
        return paramInFunc;
    }

    public void setParamInFunc(JavaFunction paramInFunc) {
    ...
    public JavaFunction getLocalInFunc() {
        return localInFunc;
    }

    public void setLocalInFunc(JavaFunction localInFunc) {
