...
public class JavaType implements java.io.Serializable {
    ...
    public List<JavaMember> getFields() {
        return fields;
    }

    public void setFields(List<JavaMember> fields) {
        this.fields = fields;
    }
    ...
    public void setFunctions(List<JavaFunction> functions) {
    ...
    public void setEnumConstants(List<JavaEnumConstant> enumConstants) {
    ...
    public JavaType getGenericImpl() {
        return genericImpl;
    }

    public void setGenericImpl(JavaType genericImpl) {
        this.genericImpl = genericImpl;
    }

    @OneToMany(fetch = FetchType.LAZY, mappedBy = "genericImpl")
    List<JavaType> genericInst = new LinkedList<JavaType>();

    public List<JavaType> getGenericInst() {
        return genericInst;
    }
    ...
    public List<JavaType> getTypeParams() {
        return typeParams;
    }

    public void setTypeParams(List<JavaType> typeParams) {
