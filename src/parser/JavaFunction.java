...
public class JavaFunction implements java.io.Serializable {
    ...
    public void setMangledNameHash(long mnh) {
        this.mangledNameHash = mnh;
    }
    ...
    public JavaFunction getGenericImpl() {
        return genericImpl;
    }

    public void setGenericImpl(JavaFunction genericImpl) {
    ...
    public List<JavaVariable> getLocals() {
        return locals;
    }

    public void setLocals(List<JavaVariable> locals) {
        this.locals = locals;
    }
    ...
    public List<JavaFunction> getGenericInst() {
        return genericInst;
    }
