...
import parser.mod.JavaParserArg;
import parser.mod.JavaParsingResult;
...
public class Parser {
    ...
    private static void applySourceLevel(String sourceLevel, Map<?, ?> options) {
        ...
        } else if ("1.2".equals(sourceLevel)) {
        ...
        } else if ("1.4".equals(sourceLevel)) {
            JavaCore.setComplianceOptions(JavaCore.VERSION_1_4, options);
        } else if ("1.5".equals(sourceLevel) || "5".equals(sourceLevel)) {
            JavaCore.setComplianceOptions(JavaCore.VERSION_1_5, options);
        } else if ("1.6".equals(sourceLevel) || "6".equals(sourceLevel)) {
            JavaCore.setComplianceOptions(JavaCore.VERSION_1_6, options);
        } else if ("1.7".equals(sourceLevel) || "7".equals(sourceLevel)) {
    ...
    public static JavaParsingResult parse(JavaParserArg arg) {
        ...
        if (!csp.parse(database)) {
            System.out.println("ConnStringParser parse failed.");
            return JavaParsingResult.Fail;
        }
        ...
        try {
            ...
            if (exitStatus == 0) {
                ...
                System.out.println("exitStatus is not 0");
                return JavaParsingResult.Fail;
            }
